...
{
	if (DK_LJ_Guy call DK_fnc_checkIfVisUnit) then
	{
		...
		call
		{
			if (_dis < 15) exitWith
			{
				...
				drawIcon3D [DK_vImg3d_arwMateDown,[0.572,0.909,0,_opak],_pos,0.5,0.5,0, "L.J.",2,0.036,"TahomaB","center",true];
			};
			...
			if ( (_dis >= 15) && (_dis <= 40) ) exitWith
			{
				...
				drawIcon3D [DK_vImg3d_arwMateDown,[0.572,0.909,0,_opak],_pos,0.4,0.4,0, "L.J.",2,0.032,"TahomaB","center",true];
			};
			...
			if ( (_dis > 40) && (_dis <= 75) ) exitWith
			{
				...
				drawIcon3D [DK_vImg3d_arwMateDown,[0.572,0.909,0,_opak],_pos,0.32,0.32,0, "L.J.",2,0.030,"TahomaB","center",true];
			};
			...
			if ( (_dis > 75) && (_dis < 140) ) exitWith
			{
				...
				drawIcon3D [DK_vImg3d_arwMateDown,[0.572,0.909,0,_opak],_pos,0.23,0.23,0, "L.J.",2,0.025,"TahomaB","center",true];
			};

			if ((_dis >= 140) && (_dis < 350)) exitWith
			{
				call
				{
					if (isNull objectParent DK_LJ_Guy) exitWith
				...
				drawIcon3D [DK_vImg3d_arwMateDown,[0.572,0.909,0,_opak],_pos,0.21,0.21,0, "L.J.",2,0.020,"TahomaB","center",true];
			};
		};
	};
};